...
<div class="content col-10">
    <div class="row main-box">
        <div class="col-xl-3 col-sm-12 icons">
            <div class="row">
                <i class="far fa-building col-xl-12 col-6"></i>
                <i class="fas fa-hammer fa-flip-horizontal col-xl-12 col-6"></i>
            </div>
        </div>
        <div class="jumbotron col-xl-8 col-sm-12">
